        ...
        <div className="w-full md:w-1/4 bg-white p-6 rounded-lg shadow h-fit">
          ...
          <nav className="space-y-2">
            <button
              ...
              className={`w-full text-left p-3 rounded transition ${activeTab === "info" ? "bg-blue-50 text-blue-600 font-bold" : "hover:bg-gray-50"}`}
            >
              📝 Profil Bilgileri
            </button>
            <button
              onClick={() => setActiveTab("password")}
              className={`w-full text-left p-3 rounded transition ${activeTab === "password" ? "bg-blue-50 text-blue-600 font-bold" : "hover:bg-gray-50"}`}
            >
              🔒 Şifre Değiştir
            </button>
            {isSeller && (
              <button
                ...
                className={`w-full text-left p-3 rounded transition ${activeTab === "adverts" ? "bg-orange-50 text-orange-600 font-bold" : "hover:bg-gray-50"}`}
              >
                📋 İlanlarım
              </button>
            )}
            <button
              onClick={logout}
              className="w-full text-left p-3 rounded text-red-600 hover:bg-red-50 mt-4 border-t"
            >
              🚪 Çıkış Yap
            </button>
          </nav>
        ...
        <div className="w-full md:w-3/4 bg-white p-6 rounded-lg shadow">
          ...
          {activeTab === "info" && (
            <div className="space-y-8">
              <form
                onSubmit={submitInfo(onUpdateInfo)}
              ...
              >
                ...
                {isSeller && (
                  <div className="bg-orange-50 p-4 rounded border border-orange-200 mb-6">
                    ...
                    <input
                      ...
                      className="w-full border p-2 rounded focus:ring-2 focus:ring-orange-500 outline-none uppercase font-bold text-gray-700"
                ...
                <button
                  type="submit"
                  className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 font-bold transition w-full md:w-auto"
                >
                  Bilgileri Güncelle
                </button>
              </form>
              ...
              <div className="pt-8 mt-8 border-t border-gray-200">
                <h4 className="text-red-600 font-bold mb-4">
                  ⚠️ Hesap İşlemleri
                </h4>
                    ...
                    <div className="bg-orange-50 p-4 rounded border border-orange-100">
                      {!showSellerDeleteConfirm ? (
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                          <div>
                            <span className="text-sm font-bold text-orange-800 block">
                              Satıcı Hesabını Kapat
                            </span>
                            <span className="text-xs text-orange-700">
                              İlanlarınız silinir, normal üye olarak kalırsınız.
                            </span>
                          </div>
                          <button
                            onClick={() => setShowSellerDeleteConfirm(true)}
                            className="text-xs bg-orange-100 text-orange-700 px-4 py-2 rounded hover:bg-orange-200 font-bold transition whitespace-nowrap"
                          >
                            Satıcılığı Bırak
                          </button>
                        </div>
                        ...
                        <div className="animate-fade-in">
                          ...
                          <div className="flex flex-col sm:flex-row gap-2">
                            <input
                              ...
                              onChange={(e) =>
                                setSellerDeletePassword(e.target.value)
                              }
                            />
                            <button
                              onClick={handleDeleteSellerAccount}
                              className="bg-orange-600 text-white px-4 py-2 rounded font-bold text-sm hover:bg-orange-700 transition"
                            >
                              Onayla
                            </button>
                            <button
                    ...
                    {!showDeleteConfirm ? (
                      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <button
                          ...
                          className="text-xs bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 font-bold transition whitespace-nowrap"
                        >
                          Hesabımı Sil
                        </button>
                      </div>
                      ...
                      <div className="animate-fade-in">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          ...
                          <button
                            ...
                            className="bg-red-600 text-white px-4 py-2 rounded font-bold text-sm hover:bg-red-700 transition"
                          >
                            Onayla ve Sil
                          </button>
                          <button
          ...
          {activeTab === "password" && (
            ...
            >
              ...
              <button
                type="submit"
                className="bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 font-bold transition w-full md:w-auto"
              >
                Şifreyi Güncelle
              </button>
            </form>
          ...
          {activeTab === "adverts" && isSeller && (
            <div>
              <div className="flex justify-between items-center mb-4 border-b pb-2">
                ...
                <Link
                  to="/create-advert"
                  className="bg-orange-500 text-white text-sm px-3 py-1 rounded hover:bg-orange-600 font-bold"
                >
                  + Yeni İlan
                </Link>
              </div>
              {loadingAdverts ? (
                ...
                <div className="space-y-4">
                  ...
                  {myAdverts.map((ad) => (
                    <div
                      key={ad.advertId}
                      className="flex items-center justify-between border p-4 rounded hover:shadow-md transition bg-gray-50"
                    >
                      ...
                      <div className="flex gap-2">
                        <Link
                          to={`/edit-advert/${ad.advertId}`}
                          className="bg-blue-100 text-blue-600 px-3 py-1 rounded text-sm hover:bg-blue-200 font-medium"
                        >
                          Düzenle
                        </Link>
                        <button
                          onClick={() => onDeleteAdvert(ad.advertId)}
                          className="bg-red-100 text-red-600 px-3 py-1 rounded text-sm hover:bg-red-200 font-medium"
                        >
                          Sil
                        </button>
                      </div>
