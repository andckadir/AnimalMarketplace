...
export default function EditAdvert() {
  ...
  const handleImageDelete = async (image) => {
    ...
    try {
      ...
      setImages((prev) =>
        prev.filter((img) => (img.id || img.imageId) !== imgId),
      );
    } catch (error) {
      console.error(error);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-3 rounded-lg font-bold hover:bg-blue-700 transition shadow-md mt-4"
            >
              Bilgileri Kaydet
            </button>
          </form>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="border-2 border-dashed border-orange-200 bg-orange-50 rounded-lg p-4 text-center hover:bg-orange-100 transition cursor-pointer relative">
            ...
            <div className="space-y-1 pointer-events-none">
              ...
              <span className="text-orange-700 font-bold block">
          ...
          <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
            {images.map((img) => (
              <div
                ...
                className={`flex gap-3 p-2 border rounded-lg bg-white shadow-sm ${img.isPrimary ? "ring-2 ring-green-500 border-transparent" : ""}`}
              >
                {/* Küçük Resim */}
