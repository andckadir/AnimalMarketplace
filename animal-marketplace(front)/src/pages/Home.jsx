...
export default function Home() {
  ...
  const handleFilterChange = (e) => {
    ...
    if (name === "city") {
      ...
      setFilters((prev) => ({
        ...prev,
        businessName: value === "" ? null : value.toUpperCase(),
      }));
    } else {
      setFilters((prev) => ({
        ...prev,
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              {Object.entries(ANIMAL_KINDS).map(([k, v]) => (
          ...
          <div>
            ...
            <select
              ...
              className="w-full border p-2 rounded outline-none disabled:bg-gray-100 focus:ring-2 focus:ring-blue-100"
            >
              <option value="">Tümü</option>
              {districts.map((d) => (
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-xs text-gray-500">Min Fiyat</label>
              <input
                type="number"
                name="minPrice"
                onChange={handleFilterChange}
            ...
            <div>
              <label className="text-xs text-gray-500">Max Fiyat</label>
              <input
                type="number"
                name="maxPrice"
                onChange={handleFilterChange}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-xs text-gray-500">Min Yaş</label>
              <input
                type="number"
                name="minAge"
                onChange={handleFilterChange}
            ...
            <div>
              <label className="text-xs text-gray-500">Max Yaş</label>
              <input
                type="number"
                name="maxAge"
                onChange={handleFilterChange}
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {adverts.map((ad) => {
                ...
                return (
                  <Link
                    to={`/advert/${ad.advertId}`}
                    key={ad.advertId}
                    className="group bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition duration-300 flex flex-col h-full relative"
                  >
                    {/* FAVORİ BUTONU */}
                    <button
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <h3
                        className="font-bold text-lg text-gray-800 truncate mb-2"
                        title={ad.title}
                      >
                        {ad.title}
                      </h3>
