    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Hayvan dostlarımız için hemen üye ol.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    />
                    {errors.surname && <p className="text-red-500 text-xs mt-1 ml-1">{errors.surname.message}</p>}
                </div>
            </div>
        ...
        <p className="text-center text-gray-600 mt-6 text-sm">
            Zaten hesabın var mı? <Link to="/login" className="text-blue-600 font-bold hover:underline">Giriş Yap</Link>
        </p>
      </div>
    </div>
  );
