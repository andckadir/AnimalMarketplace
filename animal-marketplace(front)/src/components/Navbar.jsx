      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {user ? (
            ...
            <>
              {/* Favorilerim */}
              <Link to="/favorites" className="hover:text-pink-200 font-medium flex items-center gap-1 transition">
              ...
              >
                <span>+</span> <span className="hidden md:inline">İlan Ver</span>
              </Link>

              {/* Profil Linki */}
              <Link to="/profile" className="flex items-center gap-2 hover:text-blue-200 transition font-medium">
